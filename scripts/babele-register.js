  ...
  for (const lang of langs) {
    try {
      babele.register({
        ...
        console.log(`[Babele - translate-dnd5e-mm-2024-es] Registered for lang="${lang}" (dir=compendium)`);
    } catch (err) {
        console.error(`[Babele - translate-dnd5e-mm-2024-es] Failed registering for lang="${lang}"`, err);
    }
  }
}
